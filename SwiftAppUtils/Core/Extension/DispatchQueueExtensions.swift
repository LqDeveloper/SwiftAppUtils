...
public extension DispatchQueue {
    ...
    /// - Returns: DispatchQueue
    @available(iOS 10.0, *)
    static func serialQueue(_ label:String,_ qos: DispatchQoS = .default,_ autoreleaseFrequency: AutoreleaseFrequency = .workItem,_ target: DispatchQueue? = nil) -> DispatchQueue{
        
        return DispatchQueue.init(label: label, qos: qos,autoreleaseFrequency: autoreleaseFrequency, target: target)
    }
